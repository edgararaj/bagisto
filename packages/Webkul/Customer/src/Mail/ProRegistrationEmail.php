...
class ProRegistrationEmail extends Mailable
{
    ...
    public function mailToCustomer()
    {
        return $this->from(core()->getSenderEmailDetails()['email'], core()->getSenderEmailDetails()['name'])
            ->to($this->data['email'])
            ->subject(trans('shop::app.mail.customer.registration.customer-pro-registration'))
            ->view('shop::emails.customer.pro-registration')->with('data', $this->data);
    }
    ...
    {
        Debugbar::info(core()->getAdminEmailDetails()['email']);
        return $this->from(core()->getSenderEmailDetails()['email'], core()->getSenderEmailDetails()['name'])
            ->to(core()->getAdminEmailDetails()['email'])
            ->subject(trans('shop::app.mail.customer.registration.customer-pro-registration'))
            ->view('shop::emails.admin.pro-registration')->with('data', $this->data);
    }
}
