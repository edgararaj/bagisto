...
use Webkul\Customer\Mail\ProRegistrationEmail;
        ...
        if (core()->getConfigData('customer.settings.email.verification')) {
            ...
            try {
                // if (core()->getConfigData('emails.general.notifications.emails.general.notifications.registration')) {
                    Mail::queue(new ProRegistrationEmail(request()->all(), 'customer'));
                // }
                ...
                // if (core()->getConfigData('emails.general.notifications.emails.general.notifications.customer-registration-confirmation-mail-to-admin')) {
                    Mail::queue(new ProRegistrationEmail(request()->all(), 'admin'));
                // }
            ...
            session()->flash('info', trans('shop::app.customer.signup-form.pro-success'));
        }
