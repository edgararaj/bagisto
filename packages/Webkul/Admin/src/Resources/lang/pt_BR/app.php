...
return [
    ...
    'account' => [
        ...
        'change-password'      => 'Mudar Password da Conta',
    ...
    'users' => [
        'forget-password' => [
            ...
            'submit-btn-title' => 'Link do E-mail para Recuperar Password',
        ],
        ...
        'users' => [
            ...
            'save-btn-title'       => 'Guardar Usuário',
            'general'              => 'Geral',
            'email'                => 'Email',
            'name'                 => 'Nome',
            'password'             => 'Password',
            ...
            'current-password'     => 'Informe a Password Atual',
            'confirm-delete'       => 'Confirma a Exclusão dessa Conta',
            'confirm-delete-title' => 'Confirme a Password antes de a apagar',
            'delete-last'          => 'Ao menos um admin é obrigatório.',
            'delete-success'       => 'Sucesso! Usuário Deletado',
            'incorrect-password'   => 'A Password informada é incorreta!',
            'password-match'       => 'A Password atual não corresponde.',
            'account-save'         => 'Alterações na conta salvas com sucesso.',
            'login-error'          => 'Por favor, verifique suas credenciais e tente novamente.',
            'activate-warning'     => 'A sua conta ainda está para ser ativada, entre em contacto com o administrador.',
        ],
        ...
        'sessions' => [
            ...
            'email'                      => 'Email',
            'password'                   => 'Password',
            'forget-password-link-title' => 'Esqueceu-se da Password?',
    ...
    'sales' => [
        ...
        'shipments' => [
            ...
            'save-btn-title'    => 'Guardar Entrega',
            'qty-ordered'       => 'Qtd pedido',
    ...
    'catalog' => [
        'products' => [
            ...
            'save-btn-title'                => 'Guardar Produto',
            'general'                       => 'Geral',
        ...
        'families'   => [
            ...
            'save-btn-title'       => 'Guardar Família',
            'general'              => 'Geral',
        ...
        'categories' => [
            ...
            'save-btn-title'           => 'Guardar Categoria',
            'general'                  => 'Geral',
            'name'                     => 'Nome',
    ...
    'configuration' => [
        ...
        'tax-categories' => [
            ...
            'save-btn-title'  => 'Guardar Categorias de Imposto',
        ...
        'tax-rates' => [
            ...
            'save-btn-title' => 'Guardar Taxas de Imposto',
            'general'        => 'Taxas de Imposto',
            'identifier'     => 'Identificador',
            'is_zip'         => 'Ativar Range de Código Postal',
            'zip_from'       => 'Código Postal de',
            'zip_to'         => 'Código Postal para',
            'state'          => 'Estado',
            ...
            'is_zip'         => 'Ativar intervalo de Código Postal',
        ],
    ...
    'settings' => [
        ...
        'exchange_rates'    => [
            ...
            'save-btn-title'           => 'Guardar Taxa de Câmbio',
            'general'                  => 'Geral',
        ...
        'inventory_sources' => [
            ...
            'save-btn-title'    => 'Guardar Origem de Estoque',
            'general'           => 'Geral',
            'code'              => 'Código',
            'name'              => 'Nome',
            'description'       => 'Descrição',
        ...
        'channels'          => [
            ...
            'save-btn-title'         => 'Guardar Canal(Loja)',
            'general'                => 'Geral',
            'code'                   => 'Código',
            'name'                   => 'Nome',
            'description'            => 'Descrição',
        ...
        'tax-categories' => [
            ...
            'save-btn-title'  => 'Guardar Categoria de Imposto',
        ...
        'tax-rates'   => [
            ...
            'save-btn-title' => 'Guardar Taxas de Impostos',
    ...
    'customers' => [
        ...
        'addresses' => [
            ...
            'save-btn-title'      => 'Guardar endereço',
            'general'             => 'Geral',
    ...
    'promotions' => [
        'cart-rules' => [
            ...
            'save-btn-title'                 => 'Regra Guardar carrinho',
        ...
        'catalog-rules' => [
            ...
            'save-btn-title'               => 'Guardar regra de catálogo',
            'rule-information'             => 'Informações sobre regras',
            'name'                         => 'Nome',
            'description'                  => 'Descrição',
            'status'                       => 'Status',
    ...
    'cms' => [
        'pages' => [
            ...
            'channel'          => 'Canais',
            'locale'           => 'Localidades',
            'create-btn-title' => 'Guardar pagina',
            'edit-title'       => 'Editar Página',
            'edit-btn-title'   => 'Guardar pagina',
